    ...
    return (
        <Layout pageTitle="Features" pageDescription="Features page">
            ...
            <div className="page-header text-center bg-[url('/bg1.jpg')] py-[125px]">
                    ...
                    <div className="features">
                        <div className="flex -mx-[10px] items-center mb-[7rem]">
                            ...
                            <div className=" flex-1 px-[10px]">
                                ...
                                <p className="w-[560px] text-[20px] font-medium leading-[30px]">Enjoy lightning-fast and secure money transfers and receiving processes, ensuring your funds reach their destination promptly and safely.</p>
                                <ul className="mt-10">
                        ...
                        <div className="flex -mx-[10px] items-center mb-[7rem]">
                            <div className=" flex-1 px-[10px]">
                                ...
                                <p className="w-[522px] text-[20px] font-medium leading-[30px]">Take advantage of competitive exchange rates, ensuring you get the most value out of your money when converting currencies.</p>
                                <ul className="mt-10">
                                    <li className="relative inline-flex items-start w-full pr-4 py-2 lg:text-lg font-medium text-gray-700">
                                        <img className="w-auto mr-4 mt-1" src="/track/5.png" alt="check icon" />                        
                ...
                <div className="transpay bg-purple-900 pt-[61px] pb-[92px] px-[149px]">
                    <div className="container">
                        ...
                        <div className="feature-box-section flex -mx-[8px]">
                            {
                                data.corefeature.map((feature, index) => (
                                    <div className=" px-[8px]" key={'featurebox' + index}>
