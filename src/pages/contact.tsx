    ...
    return (
        <Layout pageTitle="Features" pageDescription="Features page">
            <div className="bg-white-900 mt-[108px] xl:mt-32">
                <div className="page-header text-center bg-[url('/contact.jpg')] bg-center bg-no-repeat bg-cover py-[110px] px-[10px]">
                ...
                <div className="container mx-auto my-[10rem] px-[10px]">
                    <div className="flex flex-wrap -mx-[10px] items-end">
                        <div className="lg:flex-1 px-[10px] lg:mb-0 mb-[30px]">
                            <div className="contact-info rounded-2xl py-[22px] px-[33px] bg-seagreen-900 lg:mr-[3rem]">
                                ...
                                <ul>
                                    <li className="flex mb-[36px] items-center">
                                    ...
                                    <li className="flex mb-[62px] items-center">
                                        <svg className="mr-[15px] w-[25px]" xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25" fill="none">
